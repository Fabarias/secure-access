...
public class SeleccionRolController {
    ...
    private void accesoLoginCiudadano(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlCiudadano = new FXMLLoader(getClass().getResource("/ui/auth/login-ciudadano.fxml"));
    ...
    private void accesoLoginPolicia(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlPolicia = new FXMLLoader(getClass().getResource("/ui/auth/login-policia.fxml"));
    ...
    private void verEleccionAdministrador(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlTercera = new FXMLLoader(getClass().getResource("/ui/auth/seleccion-admin.fxml"));
